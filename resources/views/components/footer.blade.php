        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-4">
                    ...
                    <p><a href="" class="footer-link-more">Lihat Selengkapnya</a></p>
                </div>
                <div class="col-6 col-lg-2">
                    <h3 class="footer-heading">Menu Navigasi</h3>
                    <ul class="footer-links list-unstyled">
                        <li><a href="index.html" class="text-dark"><i class="bi bi-chevron-right"></i> Beranda</a></li>
                        <li><a href="index.html"><i class="bi bi-chevron-right"></i> Tentang</a></li>
                        <li><a href="category.html"><i class="bi bi-chevron-right"></i> Esai</a></li>
                        <li><a href="single-post.html"><i class="bi bi-chevron-right"></i> Film</a></li>
                    </ul>
                </div>
                <div class="col-6 col-lg-2">
                ...
                <div class="col-lg-4">
                    ...
                    <ul class="footer-links footer-blog-entry list-unstyled">
                        @foreach ($essays as $essay)
                            <li>
                                <a href="{{ $essay->slug }}" class="d-flex align-items-center">
                                    <div>
